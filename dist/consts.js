...
export const CUTEDOG_LINEAR_GRADIENT = 'linear-gradient(135deg, #69CCF0, #2C88D1)';
export const WINNING_SELECTOR = '.winning';
export const RANKING_ELEMENT_ID = 'ranking';
export const API_URL = 'https://raw.githubusercontent.com/ravenuy/subsDpsMeter/refs/heads/main/data.json';
export const FLAG_CDN_NA = 'https://flagcdn.com/w320/us.png';
export const FLAG_CDN_EU = 'https://flagcdn.com/w320/eu.png';
export const FLAG_CDN_NZ = 'https://flagcdn.com/w320/nz.png';
export const SEVEN_CDN = 'https://cdn.7tv.app/emote';
export const EMOTE_SIZE = 3;
export const EMOTE_FORMAT = 'webp';
export const NA = 'NA';
export const EU = 'EU';
export const NZ = 'NZ';
export const CUTEDOG = 'CuteDog_';
export const UPDATE_RANKINGS_INTERVAL = 60000;
